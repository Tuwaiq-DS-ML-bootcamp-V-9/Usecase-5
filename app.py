...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
     ...
     <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
      ...
      <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
والأحلى من كذا؟ الفرص الوظيفية للخريجين بدون خبرة أعلى بكثير! يعني جدارات مضبطينك ومجهّزين لك انطلاقك في سوق العمل      </p>
</div>
""", unsafe_allow_html=True)
...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    ...
    إذا كنت حديث تخرج وما عندك خبرة، أكيد يهمك تعرف كم القيمة السوقية لرواتب  بحيث تقدر تقارن بين العروض الوظيفية عشان تختار الافضل
        </p>
</div>
""", unsafe_allow_html=True)
...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
    وبما أن منصة جدارات تخدم معظم المناطق بالسعودية، بعرض لك وين اكثر العروض وظيفية، عشان تعرف وين تكون فرصتك أكبر في القبول      </p>
</div>
""", unsafe_allow_html=True)
...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
     ...
     <p style="color: #0B67B7; font-size: 25px;">
      لو انت مو ساكن باحد المدن الاكثر فرص ارشح تتنقل  
...
# محاذاة النص لليمين، تغيير اللون إلى الأبيض، جعله عريضًا وزيادة الحجم بالإضافة إلى تكبير الحقول
st.markdown("""
    <style>
...
if selected_category != 'اختار التصنيف' and selected_region != 'اختار المنطقة':
    ...
    ][['comp_name', 'comp_no', 'salary_extracted', 'benefits', 'qualif', 'job_desc', 'total_positions', 'available_positions', 'experience_category', 'gender']]
...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
من الآخر؟ بدال قعدة البيت واسئلة العالم اللي ما تخلص، ادخل على جدارات وقدّم ... فالك التوفيق
</div>
""", unsafe_allow_html=True)
