...
def charts_section():
    ...
    st.markdown("""📌 **تحليل:** يعكس هذا المخطط التوزيع الجغرافي للوظائف، حيث يمكن ملاحظة أن بعض المناطق تحتوي على فرص عمل أكثر من غيرها. قد يكون هذا مرتبطًا بالكثافة السكانية أو تركز الأنشطة الاقتصادية في بعض المناطق مثل المدن الكبرى.""")
    ...
    st.markdown("""📌 **تحليل:** يوضح هذا الرسم التوزيع النسبي للفرص الوظيفية بين الجنسين. يمكن أن يساعد هذا التحليل في تحديد ما إذا كانت هناك فجوات في سوق العمل بناءً على الجنس، مما قد يشير إلى الحاجة إلى سياسات توظيف أكثر شمولًا.""")
    ...
    st.markdown("""📌 **تحليل:** يساعد هذا المخطط الباحثين عن عمل على تحديد الوظائف ذات الرواتب المرتفعة. يمكن أن يكون مفيدًا أيضًا للشركات في معرفة مستوى الرواتب المناسب لجذب المواهب في سوق العمل.""")
