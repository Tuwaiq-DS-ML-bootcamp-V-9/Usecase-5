...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
     ...
     <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
      ...
      <p style="color: #0B67B7; font-size: 30px; font-weight: bold; margin-bottom: 20px;">
والأحلى من كذا؟ الفرص الوظيفية للخريجين بدون خبرة أعلى بكثير! يعني جدارات مضبطينك ومجهّزين لك انطلاقك بسوق العمل      </p>
</div>
""", unsafe_allow_html=True)
...
<div style="text-align: right; padding: 20px; background-color: #f0f8ff; border-radius: 10px;">
    ...
    إذا كنت حديث تخرج وما عندك خبرة، أكيد يهمك تعرف كم قيمة السوقية لحديثين التخرج بحيث تقدر تقارن بين العروض الوظيفية عشان تختار الافضل
        </p>
</div>
""", unsafe_allow_html=True)
