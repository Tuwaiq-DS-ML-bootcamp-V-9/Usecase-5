...
st.markdown('🔎 What proportion of job postings is attributed to each region within the king')
st.image("fig_1.png", caption="")
st.markdown('<hr class="divider-custom">', unsafe_allow_html=True)

st.markdown('📊 Is there a gender preference indicated in the job postings?')
st.image("fig_2.png", caption="")
st.markdown('<hr class="divider-custom">', unsafe_allow_html=True)

st.markdown('📊 What is the expected salary range for fresh graduates?')
