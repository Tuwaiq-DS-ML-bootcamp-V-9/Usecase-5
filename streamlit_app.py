...
def main():
    ...
    #  نهاية القصة
    st.markdown("""
    <div style='background-color: #e6f7e6; padding: 10px; border-radius: 5px; text-align: center;'>
        <h3>🔍 العبرة:</h3>
        <p style='font-size: 18px;'>
            سوق العمل مليء بالفرص، ولكن الذكاء في البحث عن الوظيفة المناسبة هو ما يجعل الفرق!<br>
            استخدم البيانات، ابحث عن أكثر الوظائف طلبًا، ولا تخف من بدء مسيرتك المهنية في مجال مختلف قليلًا عن تخصصك<br>
            <strong>🚀!النجاح يبدأ بخطوة</strong>
        </p>
    </div>
    """, unsafe_allow_html=True)
