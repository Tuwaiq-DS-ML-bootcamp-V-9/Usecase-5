...
def main():
    ...
    <div style='text-align: center; font-size:18px; margin-top: 20px;'>
        ...
        <!-- عنوان السيناريو بخلفية خضراء -->
        <h2 style='background-color: #d4edda; color: #155724;
        ...
        <p><strong>ومع ذلك، تظهر تساؤلات عدة في بال الخريجين، مثل:</strong></p>
        ...
        <p>🏢 ماهو القطاع الذي يوفر وظائف أكثر في سوق العمل؟</p>
